window.KD = {
  ...
  packages: [
    { id: 'kerala', src: 'img/kerala.png', title: 'Kerala Getaway', price: 12999, dur: '4 Nights / 5 Days', days: 5, loc: 'Kerala', region: 'Domestic', tag: 'Backwaters',
    ...
    { id: 'himachal', src: 'img/himachal.png', title: 'Himachal Escape', price: 15999, dur: '5 Nights / 6 Days', days: 6, loc: 'Himachal Pradesh', region: 'Domestic', tag: 'Mountains',
    ...
    { id: 'goa', src: 'img/goa.png', title: 'Goa Beach Holiday', price: 13999, dur: '4 Nights / 5 Days', days: 5, loc: 'Goa', region: 'Domestic', tag: 'Beaches',
    ...
    { id: 'rajasthan', src: 'img/rajasthan.png', title: 'Rajasthan Royal Tour', price: 18999, dur: '5 Nights / 6 Days', days: 6, loc: 'Rajasthan', region: 'Domestic', tag: 'Heritage',
    ...
    { id: 'maldives', src: 'img/maldives.png', title: 'Maldives Honeymoon', price: 45999, dur: '5 Nights / 6 Days', days: 6, loc: 'Maldives', region: 'International', tag: 'Honeymoon',
  ...
  services: [
    { key: 'driver', icon: 'directions_car', title: 'Driver Assign', sub: 'Safe & Reliable Drivers', src: 'img/driver.png', service: 'Driver Assign',
    ...
    { key: 'tour', icon: 'flight', title: 'Tour Packages', sub: 'Domestic & International', src: 'img/tour.png', service: 'Tour Package',
    ...
    { key: 'hotel', icon: 'apartment', title: 'Hotel Bookings', sub: 'Luxury & Budget Stays', src: 'img/hotel.png', service: 'Hotel Booking',
    ...
    { key: 'transport', icon: 'directions_bus', title: 'Transport Services', sub: 'Cars, Vans & Buses', src: 'img/rajasthan.png', service: 'Transport',
  ...
  offers: [
    ...
    { code: 'GOA2026', off: '15% OFF', title: 'Goa Monsoon Deal', desc: '15% off Goa Beach Holiday for bookings of 2+ travellers.', valid: 'Valid till 30 Nov 2026', src: 'img/goa.png', pkg: 'goa' },
    { code: 'DRIVE20', off: '20% OFF', title: 'Driver for a Week', desc: 'Book a driver for 7+ days and get 20% off the daily rate.', valid: 'All cities', src: 'img/driver.png', pkg: '' }
  ],
